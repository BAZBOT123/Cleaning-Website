            ...
            <main className="App-header">
                ...
                <div>
                    <div class="container two-column-grid">
                        <div className="box-image"><img src={HouseCleaning} alt="House cleaning" height="100%" width="80%"></img></div>
                        <div className="box-text"><h4 className="box-title">HOUSE CLEANING</h4><br />
                            <h5 className='box-paragraph'>We are aware that every house is different and has certain needs and routines.
                                ...
                                (you can pick weekly, bi-weekly, or monthly packages).</h5>
                        </div>

                        <div className="box-image"><img src={OfficeCleaning} alt="Office cleaning" height="100%" width="80%"></img></div>
                        <div className="box-text"><h4 className="box-title">OFFICE CLEANING</h4><br />
                            <h5 className='box-paragraph'>You can take care of the  business, and we’ll take care of the cleaning. When having an office,
                        ...
                        <div className="box-image"><img src={VacationCleaning} alt="Vacation cleaning" height="100%" width="80%"></img></div>
                        <div className="box-text"><h4 className="box-title">VACATION RENTAL CLEANING</h4><br />
                            <h5 className='box-paragraph'>We want your rental property to be so fresh and clean for you to show it to your future guests proudly.
                                ...
                                Book today your cleaning service through our fast and secure calling system.</h5>
                        </div>

                        <div className="box-image"><img src={DeepCleaning} alt="Deep cleaning" height="100%" width="80%"></img></div>
                        <div className="box-text"><h4 className="box-title">DEEP CLEANING</h4><br />
                            <h5 className='box-paragraph'>A deep cleaning service is recommended for houses and offices that haven’t been cleaned in a while,
                                ...
                                so you don’t have to worry about letting us in at your place. Also, you can book easily by contacting us directly by a simple call.</h5>
                        </div>

                        <div className="box-image"><img src={MovingCleaning} alt="<Moving cleaning" height="100%" width="80%"></img></div>
                        <div className="box-text"><h4 className="box-title">MOVE-IN/MOVE-OUT CLEANING</h4><br />
                            <h5 className='box-paragraph'>When you are moving to a new home, you probably are too busy for that last deep clean to your old house.
                                ...
                                All of our staff are experienced and well-trained to accomplish this job. And also, you can book easily by contacting us directly by a simple call.</h5>
                        </div>

                        <div className="box-image"><img src={PostCleaning} alt="Post cleaning" height="100%" width="80%"></img></div>
                        <div className="box-text"><h4 className="box-title">POST CONSTRUCTION CLEANING</h4> <br />
                            <h5 className='box-paragraph'>This service usually is for commercial clients who are in the real state business or may have a new renovated home, build, or apartment,
                                ...
                                Book easily by contacting us directly by a simple call.</h5>
                        </div>

                        <div className="box-image"><img src={ApartmentCleaning} alt="House cleaning" height="100%" width="80%"></img></div>
                        <div className="box-text"><h4 className="box-title">APARTMENT CLEANING</h4> <br />
                            <h5 className='box-paragraph'>Either you want a frequent service with weekly or monthly scheduled sessions, or you just want a one-time cleaning with affordable hourly rates,
                                ...
                                Book our cleaning service by contacting us directly by a simple call.</h5>
                        </div>
                    </div>
                </div>
            </main>
